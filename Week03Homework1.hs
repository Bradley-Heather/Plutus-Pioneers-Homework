...
mkValidator dat () ctx = (traceIfFalse "Deadline has not been reached" deadlineReached &&
                         traceIfFalse "Wrong Benificiary" signedByBeneficiary2) ||
                         (traceIfFalse "Deadline has passed" beforeDeadline &&
                         traceIfFalse "Wrong Benificiary" signedByBeneficiary1)
